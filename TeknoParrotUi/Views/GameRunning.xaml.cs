    ...
    public partial class GameRunning
    {
        ...
        private void GameRunning_OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (Lazydata.ParrotData.UseDiscordRPC)
            {
                ...
                {
                    case "Wangan Midnight Maximum Tune 5":
                        key = "wmmt5";
                        break;

                    case "Wangan Midnight Maximum Tune 5DX+":
                        key = "wmmt5dxp";
                        break;

                    case "Wangan Midnight Maximum Tune 6":
                        key = "wmmt6";
                        break;

                    case "Wangan Midnight Maximum Tune 6R":
                        key = "wmmt6r";
                        break;

                    case "Wangan Midnight Maximum Tune 6RR":
                        key = "wmmt6rr";
                        break;
        ...
        public void GameRunning_OnUnloaded(object sender, RoutedEventArgs e)
        {
            if (Lazydata.ParrotData.UseDiscordRPC)
            {
                DiscordRPC.UpdatePresence(new DiscordRPC.RichPresence
                {
                    ...
                    startTimestamp = (long)DateTimeOffset.UtcNow.ToUnixTimeSeconds()
                });
            }
